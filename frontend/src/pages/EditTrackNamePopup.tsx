...
const EditTrackNamePopup: React.FC<Props> = ({ onHide, setTrackName, show, token, trackName }) => {
  ...
  const handleSaveChanges = async () => {
    ...
    const response = await trackActions.updateTrack(editedTrackName, token ?? ''); // Atualiza o nome da pista
  ...
  return (
      ...
      >
        ...
        >
          <Modal.Title>{ 'Editar Nome da Pista' }</Modal.Title> { /* Título do popup "Excluir Pista/Editar Pista" (dependendo do estado do "showDeleteConfimation") */ }
        </Modal.Header>
        <Modal.Body
...
export default EditTrackNamePopup; // Exporta o componente